...
def parse_args():
    ...
    parser.add_argument('--datasetType', default='cifar100', type=str, help='svhn,imagenet, cifar100, cifar10, dataset to use')
    parser.add_argument('--num_classes', type=int, default=100, help='# dataset classes.')
    ...
    parser.add_argument('--val_batch_size', type=int, default=128,help='input batch size for val')
    ...
    parser.add_argument('--model', default='axial50m', help='Model names.')
    ...
    parser.add_argument("--label_smoothing", action='store_true', default=True, help="To use label smoothing or not.")
    ...
    parser.add_argument('--name', default='axial26s', help='the name of work_dir')
    parser.add_argument('--no_cuda', action='store_true', default=False, help='disables CUDA training')
    parser.add_argument('--lr_scheduler', type=str, default="cosine", choices=["linear", "cosine"], help='schedule learning rate')
        ...
        with torch.no_grad():
            for data, target in val_loader:
                if args.datasetType == "imagenet":
                    data = torch.cat((torch.zeros((args.batch_size, 1, 64, 64)), data), dim=1)
                elif args.datasetType == 'cifar100' or 'cifar10':
...
def train_net(args):
    ...
    print("Start training for Model: ",args.model,"...")
    #print("Start training for ",args.experimentType,"...")
    #print("Start training for ",args.experimentType,"With",args.model," ... ",args.datasetType)
